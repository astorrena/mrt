...
if (idioma == "en") {
  ...
  function bt_english() {
    ...
    $("#hablamos_form").html('<form id="hablamos-form" name="email-form" data-name="Email Form" method="post" class="form" aria-label="Email Form"><input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="Nombre" id="nombre"><input type="email" class="text-field w-input" maxlength="256" name="name-3" data-name="Name 3" placeholder="Mail" id="mail" required=""><textarea id="mensaje" name="Mensaje-2" maxlength="5000" data-name="Mensaje 2" placeholder="Mensaje" class="textarea textarea-2 text-field w-input"></textarea><label class="w-checkbox checkbox-field"><div class="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div><input type="checkbox" name="Aceptacion" id="Aceptacion" data-name="Aceptacion" required="" style="opacity:0;position:absolute;z-index:-1"><span class="checkbox-label w-form-label" for="Aceptacion">Acepto la <a href="#" class="link-2">política de privacidad</a></span></label><input type="submit" data-wait="Please wait..." value="Enviar" class="formulario-btn w-button"></form><div class="success-message w-form-done" tabindex="-1" role="region" aria-label="Email Form success"><div class="text-block">¡Gracias! Tu mensaje se ha enviado correctamente</div></div><div class="w-form-fail" tabindex="-1" role="region" aria-label="Email Form failure"><div>Oops! Something went wrong while submitting the form.</div></div>');
